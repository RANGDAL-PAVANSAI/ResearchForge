...
export const SERVICES: Service[] = [
  {
    ...
    shortDesc:
      "Professional IEEE conference and journal paper formatting to template standards.",
    description:
      "We format your research manuscripts to meet IEEE template requirements — structure, referencing, figure captions, and abstract formatting — ensuring your paper is submission-ready.",
    features: [
  ...
  },
  {
    ...
    shortDesc:
      "Professional formatting for theses, dissertations, and research manuscripts.",
    description:
      "We provide formatting services for academic manuscripts including M.Tech theses, PhD dissertations, and research papers across various formatting standards and institutional requirements.",
    features: [
  ...
  },
  {
    ...
    shortDesc:
      "Document formatting and restructuring to reduce similarity index.",
    description:
      "We provide formatting and restructuring services to help reduce similarity scores by reformatting text, improving paraphrasing structure, and ensuring proper citation formatting.",
    features: [
  ...
  },
  {
    ...
    shortDesc:
      "Complete documentation formatting for academic projects and reports.",
    description:
      "We format and structure project documentation including reports, technical documentation, and presentation materials for academic projects and final year submissions.",
    features: [
...
export const PROCESS_STEPS: ProcessStep[] = [
  {
    ...
    description:
      "Contact us via WhatsApp (7386627447) or our contact form. Share your document and formatting requirements.",
  },
  {
    step: 2,
    icon: "📄",
    title: "Review & Quote",
    description:
      "We review your document, understand the formatting requirements, and provide a clear timeline and quote.",
  },
  {
    step: 3,
    icon: "🚀",
    ...
    description:
      "We format your document according to specifications and deliver it within the agreed timeline with revision support.",
  },
];

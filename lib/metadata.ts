...
export const siteConfig = {
  ...
  url: BASE_URL,
  description:
    "ResearchForge is a newly launched academic paper preparation and formatting service for engineering students, offering IEEE paper formatting, manuscript structuring, and plagiarism formatting support.",
  keywords: [
